...
@Component({
  ...
  template: `
    ...
    <div class="container">
      <app-xml-viewer [xmlData]="xmlData"></app-xml-viewer>
    </div>
  `,
  styles: [
    `
...
export class AppComponent {
  xmlData = `<smartderivativecontract xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                         xmlns="uri:sdc"
...
</smartderivativecontract>`; // Fügen Sie hier Ihr XML ein
}
